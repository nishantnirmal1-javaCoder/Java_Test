...
import com.cartrawler.assessment.car.CarSorter;
import com.cartrawler.assessment.car.CarSorterVavr;
...
public class AssessmentRunner {
    ...
    static {
        ...
        CARS.add(new CarResult("Volkswagen Polo", "NIZA", "EDMR", 16.81d, CarResult.FuelPolicy.FULLEMPTY));
    ...
    public static void main(String[] args) {
        ...
        display.renderList(carSorter.process(CARS, false));
        System.out.println("\n---------------------------\n");
        display.renderList(carSorter.process(CARS, true));
        
        System.out.println("\n---------------------------\n");
        //display.renderList(CarSorterVavr.sort(CARS));
